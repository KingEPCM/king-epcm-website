...
(function () {
  var INDEX = [
    { u: "/", t: "Home", d: "Civil, environmental, geotechnical & permitting engineering across Ontario.",
      k: "home king epcm overview engineering land development ontario markham gta golden horseshoe" },
    { u: "/about", t: "About King EPCM", d: "Established 2019 — flexible, dependable, on-site engineering.",
      k: "about company history story 2019 flexible dependable on-site mission who we are markham stouffville" },
    { u: "/services", t: "Services", d: "All seven engineering disciplines.",
      k: "services disciplines all what we do offerings list" },
    { u: "/chemical-environmental", t: "Chemical Environmental", d: "Phase I & II ESA, contamination, remediation, excess soil.",
    ...
    { u: "/natural-heritage-environmental", t: "Natural Heritage Environmental", d: "Tree inventory, natural heritage evaluation, ecological surveys.",
    ...
    { u: "/civil-municipal-design", t: "Civil & Municipal Design", d: "Grading, drainage, servicing, stormwater, septic, floodplain.",
    ...
    { u: "/survey-inspections", t: "Survey & Inspections", d: "Topographic surveys, asphalt & concrete QA/QC, inspections.",
    ...
    { u: "/geotechnical-hydrogeology", t: "Geotechnical & Hydrogeology", d: "Soil investigation, bearing capacity, foundations, groundwater.",
    ...
    { u: "/permit-project-management", t: "Permit & Project Management", d: "Approvals, agency coordination, project delivery.",
    ...
    { u: "/mining-aggregate", t: "Mining & Aggregate", d: "Open-pit & underground engineering across Canada.",
    ...
    { u: "/team", t: "Our Team", d: "Engineers, designers, and field experts.",
    ...
    { u: "/careers", t: "Careers", d: "Join our engineering team.",
      k: "careers jobs hiring employment join work apply resume open positions opportunities engineer" },
    { u: "/contact", t: "Contact & Request a Quote", d: "Reach us or request a project quote.",
    ...
    { u: "/pay", t: "Pay Invoice / Retainer", d: "Pay an invoice or retainer (e-transfer, cheque, card).",
